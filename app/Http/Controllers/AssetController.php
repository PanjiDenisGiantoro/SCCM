    ...
    public function getDataFacility(Request $request)
    {
        ...
        return DataTables::of($facility)
            ->addColumn('expand', function ($facility) {
                ...
                return $hasChildren ? '<button class="btn btn-primary btn-sm toggle-child" data-id="' . $facility->id . '">+</button>' : '';
            })
            ->editColumn('name', function ($facility) {
                return $facility->name;
            })
            ->editColumn('status', function ($facility) {
                return $facility->status == '1' ? 'Online' : 'Offline';
            })
            ...
            ->addColumn('action', function ($facility) {
                return '
            <button class="btn btn-outline-primary btn-sm editBtn" data-id="' . $facility->id . '"><i class="fa fa-edit"></i></button>
            <button class="btn btn-danger btn-sm deleteBtn" data-id="' . $facility->id . '"><i class="fa fa-trash"></i></button>
            ';
            })
