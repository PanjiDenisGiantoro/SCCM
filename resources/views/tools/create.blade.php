                ...
                <div class="col-lg-12">
                    <div class="card mb-3">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h6 class="card-title mb-0">Tools Form</h6>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start mb-4">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <div class="mb-2">
                                        <label class="form-label">New Tools</label>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <ul class="nav nav-tabs mb-4 bg-body-secondary" id="myTab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="warranies-tab" data-bs-toggle="tab" data-bs-target="#warranies"
                                            type="button" role="tab" aria-controls="warranies" aria-selected="false">Warranties
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
...
{{--                                        </div>--}}
                                ...
                                <div class="tab-pane fade" id="warranies" role="tabpanel" aria-labelledby="warranies-tab">
                                    <!-- Modal -->
                                ...
                                <div class="tab-pane fade" id="parts" role="tabpanel" aria-labelledby="parts-tab">
                                    ...
                                    <div class="modal fade" id="addPartModal" tabindex="-1"
                                         aria-labelledby="addPartModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
...
<script>
    $(document).ready(function () {
        ...
        function loadCategories() {
            $.ajax({
                url: '{{ route("categories.getFacility3") }}',
                method: 'GET',
                ...
                .then(data => {
                    if (data.success) {
                        swal.fire({
                            ...
                            console.log(data);
                            window.location.href = "{{ route('tools.list') }}";
                        });
                    } else {
                        swal.fire({
                            icon: 'error',
...
<script>
    document.addEventListener("DOMContentLoaded", async function () {
        ...
        try {
            const response = await fetch("{{ route('equipment.gettools') }}");
            if (!response.ok) throw new Error("Failed to fetch locations");
