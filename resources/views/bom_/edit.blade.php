                                ...
                                @foreach($bomFacilities as $item)
                                    <tr data-id="{{ $item->bom_id }}" data-index="{{ $loop->index }}">
                                        <td>
                                            ...
                                            <input class="form-control" hidden type="text" name="bom[{{ $loop->index }}][code]" value="{{ $item->code }}" readonly>{{ $item->code }}
                                        </td>
                                        <td>
                                            <input class="form-control" hidden type="text" name="bom[{{ $loop->index }}][name]" value="{{ $item->name }}" readonly>{{ $item->name }}
                                        </td>
                                        <td>
                                            <input class="form-control" hidden type="text" name="bom[{{ $loop->index }}][category]" value="{{ $item->category_name }}" readonly>{{ $item->category_name }}
                                        </td>
                                        <td>
                                            <input class="form-control" hidden type="text" name="bom[{{ $loop->index }}][asset]" value="{{ $item->bom_id  }}" readonly>{{ $item->bom_id  }}
                                        </td>
                                        <td>
                                            <input class="form-control" hidden type="text" name="bom[{{ $loop->index }}][location]" value="{{ $item->id_location }}" readonly>{{ $item->id_location }}
                                        </td>
                                        <td>
