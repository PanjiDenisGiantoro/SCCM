                ...
                <div class="d-flex flex-wrap align-items-center justify-content-end gap-2">
                    ...
                    <a href="{{ url('purchase/download/' . $purchase->id ) }}" target="_blank"
                       ...
                       onclick="printInvoice()">
                        ...
                        @if($purchase->user_id == Auth::user()->id && $purchase->status == 1)
                            <a href="javascript:void(0)"
                    ...
                    <div class="col-lg-8">
                        <div class="shadow-4 border radius-8">
                            <div class="p-20 d-flex flex-wrap justify-content-between gap-3 border-bottom">
                                <div>
                                    <h3 class="text-xl"> {{ $purchase->po_number }} ( @if($purchase->status == 0)
                                            Pending
                                    ...
                                    @foreach($approve_user as $user)
                                        <div class="signature-box">
                                            ...
                                            @if($user->approval_required == 'APPROVE')
                                                <iconify-icon icon="ic:baseline-check-circle" class="text-success"
                                                              style="font-size: 18px;"></iconify-icon>
                                            @else
                                                <iconify-icon icon="ic:baseline-cancel" class="text-danger"
                                                              style="font-size: 18px;"></iconify-icon>
                                            @endif
                                        </div>
                                    @endforeach
    ...
    <div class="modal fade" id="approveModal" tabindex="-1" aria-labelledby="approveModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ url('purchase_order/approve/' . $purchase->id) }}" method="POST">
                    @csrf
